...
class RoutinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create routine" do
    assert_difference('Routine.count') do
      post routines_url, params: { routine: { date: @routine.date, days: @routine.days, name: @routine.name, user_id: @routine.user_id, weekly_frequency: @routine.weekly_frequency } }
    end
  ...
  test "should update routine" do
    patch routine_url(@routine), params: { routine: { date: @routine.date, days: @routine.days, name: @routine.name, user_id: @routine.user_id, weekly_frequency: @routine.weekly_frequency } }
